...
################################################################################
## Form generated from reading UI file 'ui_mainaPTBzp.ui'
##
...
"}")
        ...
        self.horizontalLayout_16.addWidget(self.btnHallLoadCur)

        self.btnHallStopCur = QPushButton(self.menuHall)
        self.btnHallStopCur.setObjectName(u"btnHallStopCur")
        self.btnHallStopCur.setMinimumSize(QSize(0, 70))

        self.horizontalLayout_16.addWidget(self.btnHallStopCur)
...
"}")
        ...
        self.scrollAreaSettings.setGeometry(QRect(0, 0, 1273, 803))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnHallLoadCur.setText(QCoreApplication.translate("MainWindow", u"START CURVA", None))
        self.btnHallStopCur.setText(QCoreApplication.translate("MainWindow", u"STOP CURVA", None))
